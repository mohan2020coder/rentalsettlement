...
func (a *App) buildComponents() {
	...
	a.Components.Inspections = inspections.NewService(inspections.NewRepository(a.Deps.DB), a.Components.Tenancies, propRepo, a.Components.Billing, a.Components.Audit, a.Components.Notifications, a.Deps.Storage)
	...
	a.Components.Deductions = deductions.NewService(a.Components.DeductionsRepo, a.Components.Tenancies, a.Components.Billing, a.Components.Audit, a.Components.Notifications)
...
func (a *App) registerRoutes() {
	...
	inspections.RegisterRoutes(protected, a.Deps.DB, a.Components.Tenancies, properties.NewRepository(a.Deps.DB), a.Components.Billing, a.Components.Audit, a.Components.Notifications, a.Deps.Storage)
	...
	deductions.RegisterRoutes(protected, a.Deps.DB, a.Components.Tenancies, a.Components.Billing, a.Components.Audit, a.Components.Notifications)
